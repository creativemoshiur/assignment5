...
<body class="bg-gray-200">
    <div class="dashboard-container p-4">
        <h1 class="text-3xl font-semibold text-center text-purple-500 mb-4">User Dashboard</h1>

        <div class="user-info-box mb-8">
            <h2 class="text-2xl font-semibold text-gray-800 mb-2">Welcome, <?php echo $username ; ?></h2>
            <p class="text-gray-600">Here's your user dashboard.</p> <br>
            <h2 class="text-2xl font-semibold text-gray-800">Profile</h2>
            <p class="text-gray-600">Profile information </p><br>
